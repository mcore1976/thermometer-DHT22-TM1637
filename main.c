...
int main(void)
{
    uint8_t temperature_hi, temperature_lo, humidity_hi, humidity_lo, firstdig, seconddig, thirddig;
    uint16_t temperature, humidity, temporary;
  ...
  /* Beginning of neverending loop */
    ...
    // check if most significant bit 15 is 1 from DHT 22 temperature reading
    // if so - temperature is below zero Celsius Degrees
       if (temperature_hi > 127)  
           { // put 'minus' sign at the end instead of degrees, and clear first significant bit of temperature
             ...
             TM1637_display_segments(4, 64);
           } 
       else  
           {
             // display Celsius grade sign on fourth position, and do not change temperature reading
             TM1637_display_segments(4, 99);
            };
